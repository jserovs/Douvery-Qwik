...
import styles from './button-delete-phone.css?inline';
...
export const useSubmit = globalAction$(
  async ({ password }, { fail, cookie, params, redirect }) => {
    const serverUrl = `${urlServerNode}/api/delete-user-phone`;
...
export const ButtonDeletePhone = component$(() => {
  ...
  return (
    <div class=" container-all">
      ...
      <div class="container-title">
        <p> Deseas eleminar esta phone?</p>
        <div
